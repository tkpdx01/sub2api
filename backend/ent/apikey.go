...
type APIKey struct {
	...
	// Bound Group ID list for multi-group routing; empty means use group_id or default
	GroupIds []int64 `json:"group_ids,omitempty"`
	// Allowed model patterns (supports wildcards like claude-*); empty means no restriction
...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case apikey.FieldGroupIds, apikey.FieldAllowedModels, apikey.FieldIPWhitelist, apikey.FieldIPBlacklist:
			values[i] = new([]byte)
