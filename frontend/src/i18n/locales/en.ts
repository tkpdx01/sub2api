export default {
  ...
  keys: {
    ...
    switchToMultiGroup: 'Switch to multi-group',
    switchToSingleGroup: 'Switch to single group',
    multiGroupHint: 'Select multiple groups; requests are auto-routed to the matching group based on the model',
    allowedModelsLabel: 'Allowed Models',
    allowedModelsPlaceholder: 'claude-*, gemini-*, gpt-4o',
    allowedModelsHint: 'Comma-separated, supports * wildcards, leave empty for no restriction',
    groupsCount: 'groups',
    statusLabel: 'Status',
